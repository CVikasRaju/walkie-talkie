...
model = ModelPT.from_pretrained("ai4bharat/IndicConformer")
```
...
### NOTE
    ...
    ```shell
    python [NEMO_GIT_FOLDER]/examples/asr/transcribe_speech.py      pretrained_name="ai4bharat/IndicConformer"      audio_dir=""
    ```
